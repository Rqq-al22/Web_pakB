...
<?php 
$id = $_GET['id'];
$data = mysqli_query($con,"SELECT * FROM uraian where id_uraian=$id");
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-1">
          <div class="accordion" id="accordionExample">
           <img src=<?php echo "assets/img/dummies/".$row[4] ?> alt="online degrees">
          </div>
        </div>
