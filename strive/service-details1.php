      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1 class="heading-title">Geografis dan Lahan</h1>
              <p class="mb-0">
                Desa Bungin  Permai merupakan salah satu desa dari 24 desa yang ada di kecamatan Tinanggea.  Desa ini terletak 5 Km ke arah selatan dari ibu kota kecamatan Tinanggea. Desa  Bungin Permai memiliki luas &plusmn;5 X 15 Km<sup>2</sup> = 75 Km<sup>2</sup>
              </p>
            </div>
          </div>
        </div>
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Geografis dan Lahan</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
