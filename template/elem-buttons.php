    ...
    <div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
      <div class="container">
        <div class="az-content-left az-content-left-components">
          <div class="component-item">
            ...
            <nav class="nav flex-column">
              <a href="elem-buttons.php" class="nav-link active">Admin</a>
              <a href="elem-dropdown.php" class="nav-link">Tamu</a>
              <a href="elem-icons.php" class="nav-link">Petani</a>
            </nav>
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          ...
          <h2 class="az-content-title">Admin</h2>

    <div class="az-content-label mg-b-5">Data Admin</div>
  ...
  <tbody>
    ...
    while ($row = mysqli_fetch_assoc($data)) {
      ...
      <tr>
        ...
        <td>
          <a href="edit2.php?id=<?php echo $row['id']; ?>">
            <img src="../img/edit.png" alt="Edit" width="20">
          </a>
          <a href="delete1.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Yakin ingin menghapus data ini?')">
...
if (isset($_GET['edit']) && $_GET['edit'] == 'ubah') {
  ...
  if (isset($_POST['id'], $_POST['username'], $_POST['password'], $_POST['email'])) {
    ...
    $qry = "UPDATE admin 
            SET nama='$username', password='$password', email='$email' 
            WHERE id=$id";
...
if (isset($_POST["tombol"]) && $_POST["tombol"] == "tambah") {
    ...
    $query = "INSERT INTO admin (id, username, password, email)
              VALUES ('$id', '$username', '$password', '$email')";
    
    if (mysqli_query($connect, $query)) {
        echo "<script>alert('Data berhasil ditambahkan'); window.location.href='elem-buttons.php';</script>";
    } else {
